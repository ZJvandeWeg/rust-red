...
>
> 由于项目用到的 [`linkme`](https://github.com/dtolnay/linkme/issues/25) 这个 crate 的问题，不支持 Windows 下的 GNU 工具链（Linux 下没有问题）。你还需要安装 `rquickjs` 这个 crate 需要的 Microsoft Visual C++ 和 Windows SDK，推荐直接装 Visual Studio。
